                        ...
                        <dl className="mt-6 border-t border-white/12">
                            {productNotes.map(([label, value]) => (
                                ...
                                >
                                    ...
                                    <dd className="text-right text-[1.3rem] text-white/65">{value}</dd>
                                </div>
                            ))}
                        </dl>
                    </div>
